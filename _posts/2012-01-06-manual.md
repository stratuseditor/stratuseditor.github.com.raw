...
Stratus is a web based, programmer's editor. It's goal is to provide abundant
...
It probably will work in Safari also, but I have not tested it
...
Files can be opened either via the file manager by clicking on the file
